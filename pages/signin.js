...
import { MdPerson, MdEmail, MdLock, MdOutlineSupervisorAccount } from "react-icons/md";
...
export default function Signin() {
  ...
  return (
    <div className="container-fluid vh-100 d-flex align-items-center justify-content-center bg-light">
      <div className="row shadow  overflow-hidden w-100" style={{ maxWidth: '900px' }}>
        
        {/* Image Section */}
        <div className="col-md-6 d-none d-md-block p-0">
          <Image
            src="/signinimages.jpg"
            alt="Signup"
            width={600}
            height={600}
        ...
        <div className="col-md-6 bg-white p-4">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-4">
              ...
              <div className="input-group">
                <span className="input-group-text"><MdOutlineSupervisorAccount /></span>
                <select
